#!/bin/python3
import curses as u;s=u.initscr()
s.nodelay(1);u.noecho();u.raw();s.keypad(1);
v={'b':[],'r':0,'c':0,'i':0,'m':'N','x':0,'y':0,'R':0,'C':0,'s':s,'f':'o.txt','u':u,
...
120:'if len(b[r]):del b[r][c]\nif c and c>len(b[r])-1:c=len(b[r])-1',
...
'-- Row: "+str(r+1)+", Col: "+str(c+1));s.move(r-y,c-x);u.curs_set(1);s.refresh();i=-1'],
